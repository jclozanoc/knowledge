...
Each folder is a [topic that can include other topics](https://github.com/jclozanoc/knowledge/blob/master/SUMMARY.md) under it related to the parent topic.
...
For super fast access of this wiki, If you are on a Mac I advise you to try out [Alfred My Mind](https://github.com/nikitavoloboev/alfred-my-mind).

If you find some mistake, especially if something that I say is plain wrong, please fork [this repository](https://github.com/jclozanoc/knowledge) and make a PR with correct changes. Or [open an issue](https://github.com/jclozanoc/knowledge/issues/new) saying what you think is wrong.

Aside from GitBook search above and [Alfred My Mind](https://github.com/nikitavoloboev/alfred-my-mind), you can also use GitHub [file](https://github.com/jclozanoc/knowledge/find/master) & [text](https://github.com/jclozanoc/knowledge/search?q=karabiner&unscoped_q=karabiner) searches.
...
I'll try to make the structure of each of the posts look roughly like this:
